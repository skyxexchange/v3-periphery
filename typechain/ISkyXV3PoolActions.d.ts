...
interface ISkyXV3PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class ISkyXV3PoolActions extends Contract {
  ...
  interface: ISkyXV3PoolActionsInterface;
