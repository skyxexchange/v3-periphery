...
interface ISkyXV3PoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class ISkyXV3PoolImmutables extends Contract {
  ...
  interface: ISkyXV3PoolImmutablesInterface;
