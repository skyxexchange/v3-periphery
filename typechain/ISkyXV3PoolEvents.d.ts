...
interface ISkyXV3PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class ISkyXV3PoolEvents extends Contract {
  ...
  interface: ISkyXV3PoolEventsInterface;
