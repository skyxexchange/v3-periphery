...
describe('PoolAddress', () => {
  ...
  describe('#computeAddress', () => {
    ...
    it('matches example from core repo 1', async () => {
      expect(
        await poolAddress.computeAddress(
          '0xaC59C75246d07ab786DAd57eC318B84519ff65FB',
          '0x0EFF288275F280db38FC8d4A3116E0777370A3b5',
          '0x4200000000000000000000000000000000000006',
          3000
        )
      ).to.eq("0xDBbc5a7F8B05530aD9ECf7D2522449c7b58df2Fd")
    })
