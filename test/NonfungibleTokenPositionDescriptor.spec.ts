...
import { NonfungibleTokenPositionDescriptor, MockTimeNonfungiblePositionManager, TestERC20Permit } from '../typechain'
...
describe('NonfungibleTokenPositionDescriptor', () => {
  ...
  beforeEach('load fixture', async () => {
    ...
    const tokenFactory = await ethers.getContractFactory('TestERC20Permit')
    weth9 = tokenFactory.attach(await nftPositionDescriptor.WETH9()) as TestERC20Permit
  })
