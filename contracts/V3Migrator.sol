...
import '@skyxexchange/v3-core/contracts/libraries/LowGasSafeMath.sol';
import '@skyxexchange/v2-core/contracts/interfaces/ISkyXV2Pair.sol';
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        ISkyXV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = ISkyXV2Pair(params.pair).burn(address(this));
