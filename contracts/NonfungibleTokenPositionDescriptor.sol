    ...
    INonfungibleTokenPositionDescriptor
{
    ...
    function tokenURI(
        ...
        uint256 tokenId
    ) external view override returns (string memory result) {
        (
            ,
            ,
            address token0,
        ...
        NFTDescriptor.ConstructTokenURIParams memory params = NFTDescriptor
        ...
        result = NFTDescriptor.constructTokenURI(params);
        return result;
    }
