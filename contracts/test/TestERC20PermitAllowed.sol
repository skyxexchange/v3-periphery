...
import './TestERC20Permit.sol';
import '../interfaces/external/IERC20PermitAllowed.sol';

// has a fake permit that just uses the other signature type for type(uint256).max
contract TestERC20PermitAllowed is TestERC20Permit, IERC20PermitAllowed {
    constructor(uint256 amountToMint) TestERC20Permit(amountToMint) {}
